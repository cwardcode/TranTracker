...
(function (l, C) {
    ...
    n(G, "init", function (a, b, c) {
        ...
        if (!e && (d || g)) {
            ...
            if ((this.isCircular =
                i) && c.max === C && o - b === 2 * Math.PI)this.autoConnect = !0
        }
    });
        ...
        toYData: function (a) {
            ...
            r(b, function (b) {
                ...
                if (b.plotY !== C)if (g = b.pointAttr[b.selected ? "selected" : ""], w = z.width, s = A(z.x), v = s + w, u = D(w / 2), f = A(x ? b.q1Plot : b.lowPlot), e = A(x ? b.q3Plot : b.lowPlot), i = A(b.highPlot), o = A(b.lowPlot), n.stroke = b.stemColor || c.stemColor || y, n["stroke-width"] = q(b.stemWidth, c.stemWidth, c.lineWidth), n.dashstyle = b.stemDashStyle || c.stemDashStyle, E.stroke = b.whiskerColor || c.whiskerColor || y, E["stroke-width"] = q(b.whiskerWidth,
                    ...
                    l)b.stem.animate({d: m}), B && b.whiskers.animate({d: p}), x && b.box.animate({d: H}), b.medianShape.animate({d: I}); else {
    ...
    h.waterfall = x(h.column, {type: "waterfall", upColorProp: "fill", pointArrayMap: ["low", "y"], pointValKey: "y", init: function (a, b) {
        ...
        i = e = h = k = f;
        for (l = 0; l < g; l++)j = b[l], d = c && c[l] ? c[l] : {}, j === "sum" || d.isSum ? b[l] = i : j === "intermediateSum" || d.isIntermediateSum ? (b[l] = e, e = f) : (i += j, e += j), h = Math.min(i, h), k = Math.max(i, k);
        ...
        for (e = 1; e < b; e++)f = a[e].shapeArgs, g = a[e - 1].shapeArgs, f = ["M", g.x + g.width, g.y + c, "L", f.x, g.y + c], a[e - 1].y <
    ...
    h.bubble = x(h.scatter, {type: "bubble", pointArrayMap: ["y", "z"], trackerGroups: ["group", "dataLabelsGroup"], bubblePadding: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor"}, applyOpacity: function (a) {
        ...
        getRadii: function (a, b, c, d) {
            ...
            for (f = 0, g = i.length; f < g; f++)e = b - a, e = e > 0 ? (i[f] - a) / (b - a) : 0.5, k && (e = Math.sqrt(e)), h.push(s.ceil(c + e * (d - c)) / 2);
            this.radii = h
        }, animate: function (a) {
    ...
    N.prototype.beforePadding = function () {
        ...
        this.tickPositions && (r(this.series, function (b) {
            var c = b.options;
            if (b.bubblePadding && b.visible && (a.allowZoomOutside = !0, p.push(b), f))r(["minSize", "maxSize"], function (a) {
            ...
            if (m > 0)for (; c--;)b[c] !== null && (k = a.radii[c], d = Math.min((b[c] - i) * n - k, d), g = Math.max((b[c] - i) * n + k, g))
    ...
    n(h.spline.prototype, "getPointSpline", function (a, b, c, d) {
        ...
        if (this.chart.polar) {
            ...
            if (a && e)i = a.plotX, h = a.plotY, b = e.plotX, k = e.plotY, i = (1.5 * g + i) / 2.5, h = (1.5 * f + h) / 2.5, e = (1.5 * g + b) / 2.5, j = (1.5 * f + k) / 2.5, b = Math.sqrt(Math.pow(i - g, 2) + Math.pow(h - f, 2)), k = Math.sqrt(Math.pow(e - g, 2) + Math.pow(j - f, 2)), i = Math.atan2(h - f, i - g), h = Math.atan2(j - f, e - g), j = Math.PI / 2 + (i + h) / 2, Math.abs(i - j) > Math.PI / 2 && (j -= Math.PI), i = g + Math.cos(j) * b, h = f + Math.sin(j) * b, e = g + Math.cos(Math.PI + j) * k, j = f + Math.sin(Math.PI +
    ...
    n(y, "getSegmentPath", function (a, b) {
        var c = this.points;
        if (this.chart.polar && this.options.connectEnds !== !1 && b[b.length - 1] === c[c.length - 1] && c[0].y !== null)this.connectEnds = !0, b =
            [].concat(b, [c[0]]);
    ...
    n(t, "translate", function (a) {
        ...
        if (b.isRadial) {
            b = this.points;
            for (h = b.length; h--;)e = b[h], a = e.barX + g, e.shapeType = "path", e.shapeArgs = {d: f.symbols.arc(d[0], d[1], c - e.plotY, null, {start: a, end: a +
