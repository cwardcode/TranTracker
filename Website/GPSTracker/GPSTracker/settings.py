...
ALLOWED_HOSTS = ['localhost','127.0.0.1','.cwardcode.com']

INTERNAL_IPS = ('127.0.0.1','24.246.130.110')
...
SECRET_KEY = 'sh66r^#@n0(9lq(^c2r^x@j)_=u5*66afc6t#rn+mhihff)+h4'
...
SERIALIZATION_MODULES = {
    'geojson : tracker.geo_json_serializer',
}
