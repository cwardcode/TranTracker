...
(function (j) {
    ...
    v(z.prototype, {renderMapNavigation: function () {
        ...
        if (i(b.enableButtons, b.enabled))for (d in c)if (c.hasOwnProperty(d))f =
    ...
    t = r(u, {applyOptions: function (a, b) {
        ...
        if (f && e.mapData)if (e = d.getMapData(f, c[f])) {
    ...
    l.map = r(l.scatter, {type: "map", pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth", fill: "color"}, colorKey: "y", pointClass: t, trackerGroups: ["group", "markerGroup", "dataLabelsGroup"],
        getSymbol: s, supportsDrilldown: !0, getExtremesFromAll: !0, useMapGeometry: !0, init: function (a) {
            ...
            }), b.legendItems = f; else if (i)g = i.from, h = i.to, c = i.fromLabel, i = i.toLabel, o = n ? [0, 0, 1, 0] : [0, 1, 0, 0], n || (n = c, c = i, i = n), n = {linearGradient: {x1: o[0], y1: o[1], x2: o[2], y2: o[3]}, stops: [
                [0, g],
                [1, h]
            ]}, f = [
                {chart: b.chart, options: {}, fromLabel: c, toLabel: i, color: n, drawLegendSymbol: this.drawLegendSymbolGradient,
                    visible: !0, setState: s, setVisible: s}
            ], b.legendItems = f
            ...
            if (!d)d = this.mapMap = [];
            if (d[b] !== void 0)return c[d[b]]; else if (b !== void 0)for (; e--;)if (c[e][a] === b)return d[b] = e, c[e]
        }, translate: function () {
            var a =
            ...
            m(this.data, function (c) {
                ...
                if (d)if (m = d.length, j)l = k; else {
                    for (; m--;)if (j = d[m], g = j.from, h = j.to, (g === void 0 || i >=
                        g) && (h === void 0 || i <= h)) {
                        l = j.color;
                        break
                    }
        ...
        animateDrilldown: function (a) {
            ...
            if (!a)a = Math.min(d.width / b.width, d.height / b.height), c.shapeArgs = {scaleX: a, scaleY: a, translateX: d.x, translateY: d.y}, m(this.points, function (a) {
